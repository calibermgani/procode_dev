                                                ...
                                                @foreach ($duplicateProjectDetails as $data)
                                                    <tr>
                                                        ...
                                                        @foreach ($data->getAttributes() as $columnName => $columnValue)
                                                            @php
                                                                $columnsToExclude = ['id','QA_emp_id''ce_hold_reason','qa_hold_reason','QA_required_sampling','qa_work_status','QA_status_code','QA_sub_status_code','QA_followup_date','CE_status_code','CE_sub_status_code','CE_followup_date','duplicate_status', 'created_at', 'updated_at', 'deleted_at'];
                                                            @endphp
                                                            @if (!in_array($columnName, $columnsToExclude))
