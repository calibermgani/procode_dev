                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header" style="background-color: #139AB3;height: 84px">
                                                <h5 class="modal-title" id="exampleModalLabel" style="color: #ffffff;" >SOP</h5>
                                                    <a href= {{ asset('/pdf_folder/Ashe_Memorial_SOP.pdf') }} target="_blank">
                                            ...
                                            <div class="modal-body">
                                                <iframe src={{ asset('/pdf_folder/Ashe_Memorial_SOP.pdf') }} style="width: 100%; height: 418px;" frameborder="0" type="application/pdf"></iframe>
                                            </div>
                                            <div class="modal-footer">
