                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($data->ticket_number != 125)
                                                            <span class="svg-icon svg-icon-success mr-2 question_play" title="play">
                                                                <!-- Your SVG icon code here -->
                                                            </span>
                                                            <a class="pt-1" data-toggle="tooltip" title="View" href="">
                                                                <i class="fa far fa-eye text-success icon-circle1 mt-0"></i>
                                                            </a>
                                                        @endif
                                                    </td>
                                                </tr>
