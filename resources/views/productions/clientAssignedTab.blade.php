                                    ...
                                    @endif
                                        ...
                                        <div>
                                            ...
                                            {{-- <a href= {{ asset('/pdf_folder/'.$pdfName.'.pdf') }} target="_blank"> --}}
                                                <a href= {{ asset(isset($sopDetails) && isset($sopDetails->sop_path) ? $sopDetails->sop_path : null ) }} target="_blank">
                                ...
                                <div class="modal fade modal-second modal-left" id="myModal_sop" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <iframe src={{ asset(isset($sopDetails) && isset($sopDetails->sop_path) ? $sopDetails->sop_path : null ) }} style="width: 100%; height: 418px;" frameborder="0" type="application/pdf"></iframe>
                                            </div>
                                            <div class="modal-footer">
