        ...
        $(document).ready(function() {
            ...
            $('.modal-body').on('click', '.add_more', function() {
                ...
                if (optionsArray == null) {
                    if (inputType !== 'date_range') {
                        if (inputType == 'textarea') {
                            newElement = '<textarea name="' + columnName +
                                '[]"  class="white-smoke pop-non-edt-val form-control ' + columnName + '" rows="3" id="' +
                                columnName +
                                uniqueId +
                                '"></textarea>';
                            ...
                            newElement = '<input type="' + inputType + '" name="' + columnName +
                                '[]"  class="white-smoke pop-non-edt-val form-control ' + columnName + '"  id="' +
                                columnName +
                                uniqueId +
                                '">';
                        }
                        ...
                        newElement = '<input type="text" name="' + columnName +
                            '[]" class="form-control pop-non-edt-val date_range "' + columnName +
                            '  style="cursor:pointer" autocomplete="none" id="' +
                            columnName +
                            uniqueId +
                            '">';
                    }
                    ...
                    newElement = '<select name="' + columnName + '[]"  class="white-smoke pop-non-edt-val form-control ' +
                        columnName + '" id="' +
                        columnName +
                        uniqueId +
                        '">';
