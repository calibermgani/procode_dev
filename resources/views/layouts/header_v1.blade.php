        ...
        <div class="topbar">
            <div class="dropdown">
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <i class="fas fa-hourglass-start fa-spin slow-spin"></i> &nbsp; &nbsp; <span
                        class="text-white opacity-70 font-weight-bold font-size-base d-none d-md-inline mr-1"
                        id="timer_count"></span>
                    <?php
                    // $login_data = App\Models\Employee_Login::where('user_id',1)
                    //     ->latest()
                    //     ->first();
                    // ?>
                    @if (isset($login_data))
                        <input type="hidden" id="login_timer"
                            value="{{ $login_data->login_date }} {{ $login_data->in_time }}">
                    @else
                        <input type="hidden" id="login_timer" value="">
                    @endif
                 </div>
            </div>
            <div class="dropdown">
