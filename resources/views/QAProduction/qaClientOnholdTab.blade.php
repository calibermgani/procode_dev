                                                ...
                                                @foreach ($holdProjectDetails as $data)
                                                    <tr
                                                        ...
                                                        @foreach ($data->getAttributes() as $columnName => $columnValue)
                                                            @php
                                                                $columnsToExclude = ['CE_emp_id','ce_hold_reason','qa_hold_reason','qa_work_status','QA_required_sampling','QA_rework_comments','coder_rework_reason','coder_error_count','qa_error_count','tl_error_count','tl_comments','QA_followup_date','CE_status_code','CE_sub_status_code','CE_followup_date','created_at', 'updated_at', 'deleted_at'];
                                                            @endphp
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-md-9" style="border-left: 1px solid #ccc;" data-scroll="true" data-height="400">
                                                 ...
                                                 <div class="row mt-4">
                                                    ...
                                                    {{-- <div class="col-md-6">
                                                            <div class="form-group row" >
                                                                <label class="col-md-12 required" id="qa_hold_reason_label">
                                                                    Hold Reason
                                                                </label>
                                                                <div class="col-md-10">
                                                                    {!! Form::textarea('qa_hold_reason',  null, ['class' => 'text-black form-control','rows' => 3,'id' => 'qa_hold_reason_editable']) !!}
                                                        ...
                                                        <div class="row mt-4">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <label class="col-md-12 pop-non-edt-val" id="qa_hold_reason"></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row mt-4">
        ...
        $(document).ready(function() {
            ...
            var table = $("#client_onhold_list").DataTable({
                ...
                buttons: [{
                    ...
                    "title": 'PROCODE',
                    "filename": 'procode_qa_hold_'+date,
                    "exportOptions": {
                ...
                $row.closest('table').find('thead th input').each(function() {
                    ...
                    function handleClientPendData(clientData,headers) {
                        ...
                        $.each(headers, function(index, header) {
                            ...
                            $('textarea[id="qa_hold_reason_editable"]').val(clientData['qa_hold_reason']);
                            if (/_el_/.test(value)) {
            ...
            $(document).on('click', '.clickable-view', function(e) {
                ...
                $row.closest('table').find('thead th input').each(function() {
                    ...
                    if (/_el_/.test(value)) {
                       ...
                       $('label[id="' + header + '"]').text(value);
                       $('label[id="qa_hold_reason"]').text(clientData.qa_hold_reason);
                    }
