        ...
        try {
            ...
            if (!$existing) {
                RhEmOp::insert([
                    ...
                    'primary_insurer' => isset($request->primary_insurer) && $request->primary_insurer != "NULL" ? $request->primary_insurer : NULL,
                    'secondary_insurer' => isset($request->secondary_insurer) && $request->secondary_insurer != "NULL" ? $request->secondary_insurer : NULL,
                    'cpt' => isset($request->cpt) && $request->cpt != "NULL" ? $request->cpt : NULL,
                    'icd' => isset($request->icd) && $request->icd != "NULL" ? $request->icd : NULL,
                    'status' => isset($request->status) && $request->status != "NULL" ? $request->status : NULL,
                    'billing_notes' => isset($request->billing_notes) && $request->billing_notes != "NULL" ? $request->billing_notes : NULL,
                    'invoke_date' => carbon::now()->format('Y-m-d'),
                    'CE_emp_id' => isset($request->CE_emp_id) && $request->CE_emp_id != '-' && $request->CE_emp_id != "NULL" ? $request->CE_emp_id : NULL,
                    'QA_emp_id' => isset($request->QA_emp_id) && $request->QA_emp_id != '-' && $request->QA_emp_id != "NULL" ? $request->QA_emp_id : NULL,
                    'chart_status' => "CE_Assigned"
    ...
    public function restorationHealthcareOpDenial(Request $request)
    {
        try {
            $attributes = [
                ...
                'patient' => isset($request->patient) && $request->patient != "NULL" ? $request->patient : NULL,      
                'dob' => isset($request->dob) && $request->dob != "NULL" ? $request->dob : NULL,    
                'insurer' => isset($request->insurer) && $request->insurer != "NULL" ? $request->insurer : NULL,    
                'claim_office_no' => isset($request->claim_office_no) && $request->claim_office_no != "NULL" ? $request->claim_office_no : NULL,    
                'ins_id' => isset($request->ins_id) && $request->ins_id != "NULL" ? $request->ins_id : NULL,    
                'price' => isset($request->price) && $request->price != "NULL" ? $request->price : NULL,    
                'quantity' => isset($request->quantity) && $request->quantity != "NULL" ? $request->quantity : NULL,    
                'billed' => isset($request->billed) && $request->billed != "NULL" ? $request->billed : NULL,    
                'allowed' => isset($request->allowed) && $request->allowed != "NULL" ? $request->allowed : NULL,    
                'adjustment' => isset($request->adjustment) && $request->adjustment != "NULL" ? $request->adjustment : NULL,    
                'pri_ins_paid' => isset($request->pri_ins_paid) && $request->pri_ins_paid != "NULL" ? $request->pri_ins_paid : NULL,    
                'sec_ins_paid' => isset($request->sec_ins_paid) && $request->sec_ins_paid != "NULL" ? $request->sec_ins_paid : NULL,    
                'patient_paid' => isset($request->patient_paid) && $request->patient_paid != "NULL" ? $request->patient_paid : NULL,    
                'ins_balance' => isset($request->ins_balance) && $request->ins_balance != "NULL" ? $request->ins_balance : NULL,    
                'pt_balance' => isset($request->pt_balance) && $request->pt_balance != "NULL" ? $request->pt_balance : NULL,    
                'billing_note' => isset($request->billing_note) && $request->billing_note != "NULL" ? $request->billing_note : NULL,    
                'first_edi' => isset($request->first_edi) && $request->first_edi != "NULL" ? $request->first_edi : NULL,    
                'last_edi' => isset($request->last_edi) && $request->last_edi != "NULL" ? $request->last_edi : NULL,    
                  'status' => isset($request->status) && $request->status != "NULL" ? $request->status : NULL,    
                'day' => isset($request->day) && $request->day != "NULL" ? $request->day : NULL,   
                ...
                'ce_notes' => isset($request->ce_notes) && $request->ce_notes != "NULL" ? $request->ce_notes : NULL,   
                'invoke_date' => carbon::now()->format('Y-m-d')
            ];
